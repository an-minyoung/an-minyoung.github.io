...
<ul>
  <li>
  Button feature to the al-folio theme, now al-folio*. Buttons were taken from the [academic-portfolio](https://github.com/ys1998/academic-portfolio) theme. Otherwise the same thing. Check out [my](https://alexanderhay2020.github.io/) to see the al-folio* theme being used.
  </li><br>
  <li>
